 ...
 * and "unknown" mirrors the Dockerfile's default when nothing was injected. The source
 * URL is separate and exists only when the public deployment preflight verified it.
 *
 ...
 */
export function GET() {
  return NextResponse.json(buildProvenance(), {
