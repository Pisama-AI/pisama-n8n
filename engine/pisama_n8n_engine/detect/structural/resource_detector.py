...
from pisama_n8n_engine.detect.n8n_utils import is_ai_node_type, build_connection_map
...
class N8NResourceDetector(TurnAwareDetector):
    ...
    # AI node type checks: use is_ai_node_type() from pisama_n8n_engine.detect.n8n_utils
    ...
    # _is_ai_node_type and _build_connection_map moved to pisama_n8n_engine.detect.n8n_utils
